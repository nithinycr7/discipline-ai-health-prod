...
const features = [
  ...
  {
    title: 'Medicine nicknames',
    description:
      'We call medicines by the names your parents know — "BP wali goli" instead of "Amlodipine."',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      'Not a robotic call — a warm caretaker conversation. We analyse tone, mood, and sentiment so you see how your parent is really feeling, not just what they said.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      'Every Sunday, a comprehensive report with routine adherence trends, sentiment patterns, and a clear picture of the week.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      '"Bauji has a 14-day streak!" — gentle motivation that works.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
