...
const features = [
  ...
  },
  {
    ...
    description:
      'Every call generates a structured report — medicine-by-medicine adherence, vitals, and wellness — delivered straight to WhatsApp.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      'Every Sunday, a comprehensive report with adherence trends, mood patterns, and health insights.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
