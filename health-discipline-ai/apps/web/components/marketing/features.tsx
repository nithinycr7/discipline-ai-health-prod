...
const features = [
  {
    ...
    description: 'Hindi, Telugu, Tamil, Kannada, Bengali, Marathi, Gujarati, Malayalam, and more. Your parents hear a voice they\'re comfortable with.',
  ...
  },
  {
    ...
    description: 'Works on any phone — landline or mobile. No app downloads, no Wi-Fi, no smartphones required.',
    icon: (<svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 0 0 6 3.75v16.5a2.25 2.25 0 0 0 2.25 2.25h7.5A2.25 2.25 0 0 0 18 20.25V3.75a2.25 2.25 0 0 0-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" /></svg>),
    size: 'medium',
  },
  {
    title: 'Speaks their world',
    description: 'Uses medicine nicknames your parents know — "BP wali goli" instead of "Amlodipine." Like family, not a hospital.',
  ...
  },
  {
    ...
    description: 'Not a robotic call — a warm, caring conversation. We track tone, mood, and sentiment so you see how your parent is really feeling, not just what they said.',
  ...
  },
  {
    ...
    description: 'Optional blood pressure and glucose check-ins during the daily call.',
    icon: (<svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" /></svg>),
    size: 'small',
  },
  {
    title: 'Missed call alerts',
    description: 'If your parent doesn\'t answer, you\'re notified immediately so you can follow up.',
    icon: (<svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a23.848 23.848 0 0 0 5.454-1.31A8.967 8.967 0 0 1 18 9.75V9A6 6 0 0 0 6 9v.75a8.967 8.967 0 0 1-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 0 1-5.714 0m5.714 0a3 3 0 1 1-5.714 0" /></svg>),
    size: 'small',
  },
  {
    title: 'Weekly wellness summaries',
    description: 'Every Sunday, a comprehensive report with wellness trends, mood patterns, and a clear picture of how the week really went.',
    icon: (<svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75ZM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V8.625ZM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V4.125Z" /></svg>),
    size: 'medium',
  },
  {
    title: 'Wellness streaks',
    description: '"Bauji has a 14-day streak!" — gentle motivation that keeps them engaged.',
          ...
          {features.map((feature, index) => {
            ...
            return (
              <ScrollReveal key={feature.title} delay={index * 60}>
                <div className={`marketing-card group h-full ${colSpan}`}>
