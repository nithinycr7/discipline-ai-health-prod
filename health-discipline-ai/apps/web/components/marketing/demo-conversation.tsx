    ...
    try {
      await conversation.startSession({
        ...
        dynamicVariables: {
          ...
          screening_questions: '',
          first_message_override: `${greeting} ${displayName}! Main EchoCare AI se bol rahi hoon. Aapka khayal rakhne ke liye call kar rahi hoon aaj. Kaisi hain aap?`,
          webhook_url: '',
        },
      });
    } catch (err: any) {
